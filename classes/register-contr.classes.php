<?php
include "registerConn.classes.php";
class RegisterContr extends RegisterConn{
    private $email;
    private $pwd;
    private $confirm;
    private $alias;
    ...
    public function registerUser(){
        ...
        $this->register($this->email, $this->pwd,$this->alias,$this->names,$this->lastNames,$this->phone,$this->realImage);
    }
