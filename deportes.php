      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img src="./assets/images/deportes/noticia1.jpg" class="img-fluid" />
              <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

            </div>
            <h3 class="font-weight-600 mt-3">El Chelsea llega a la cima con la conquista del Mundial de clubes</h3>
          ...
          <div class="col-lg-6  mb-5 mb-sm-2">
            <div class="row">
              <div class="col-sm-6  mb-5 mb-sm-2">
                ...
                <h5 class="font-weight-600 mt-3">CF Monterrey vuelve a México tras Mundial de Clubes </h5>
                <p class="fs-15 font-weight-normal">
              ...
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/deportes/noticia3.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">¿Cuánto dinero cuesta un anuncio de 15 segundos en la Super Bowl?</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
            ...
            <div class="row mt-3">
              <div class="col-sm-6  mb-5 mb-sm-2">
                <div class="position-relative image-hover">
                  <img src="./assets/images/deportes/noticia4.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">Donovan Carrillo, el joven mexicano que hizo historia al clasificarse para la final de patinaje artístico en los Juegos de Invierno </h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
              <div class="col-sm-6">
                <div class="position-relative image-hover">
                  <img src="./assets/images/deportes/noticia5.jpg"class="img-fluid"/>
                  <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>

                </div>
                <h5 class="font-weight-600 mt-3">Odell Beckham Jr., la redención del chico rebelde de la NFL</h5>
                <p class="fs-15 font-weight-normal">
                  Lorem Ipsum has been the industry's standard dummy text
                </p>
              </div>
        ...
        <div class="row mb-4">
          <div class="col-sm-3  mb-5 mb-sm-2">
            <div class="position-relative image-hover">
              <img src="./assets/images/deportes/deportes.jpg"class="img-fluid"/>
              <span onclick="location.href='./noticia.php'" class="thumb-title">Ver nota</span>
